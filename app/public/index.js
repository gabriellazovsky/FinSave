...
w.innerHTML = `
  <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px">
    <strong data-i18n="comparativa.title"></strong>
  ...
  <div style="display:flex;gap:12px;align-items:center;margin-bottom:8px">
    <label style="font-size:13px;display:flex;align-items:center;gap:6px">
      ...
      <span data-i18n="comparativa.ingresos"></span>
    </label>
    <label style="font-size:13px;display:flex;align-items:center;gap:6px">
      <input type="checkbox" id="finsaveToggleGastos" checked>
      <span data-i18n="comparativa.gastos"></span>
    </label>
  </div>

  <div style="display:flex;gap:8px;align-items:center;margin-bottom:8px">
    <div style="font-size:13px;color:#555" data-i18n="comparativa.year"></div>

    <div id="finsaveYearDropdown" style="position:relative">
      <button id="finsaveYearBtn"
        style="padding:6px;border-radius:6px;border:1px solid #ddd;background:white;cursor:pointer"
        data-i18n="comparativa.selectYearsBtn">
      </button>
      <div id="finsaveYearMenu"
        style="display:none;position:absolute;left:0;top:36px;background:white;border:1px solid #ddd;padding:8px;border-radius:6px;max-height:180px;overflow:auto;z-index:100000">
      </div>
    </div>

    <div style="font-size:13px;color:#555" data-i18n="comparativa.month"></div>

    <div id="finsaveMonthDropdown" style="position:relative">
      <button id="finsaveMonthBtn"
        style="padding:6px;border-radius:6px;border:1px solid #ddd;background:white;cursor:pointer"
        data-i18n="comparativa.selectMonthsBtn">
      </button>
      <div id="finsaveMonthMenu"
        style="display:none;position:absolute;left:0;top:36px;background:white;border:1px solid #ddd;padding:8px;border-radius:6;max-height:220px;overflow:auto;z-index:100000">
      </div>
    </div>
  </div>

  <div style="margin-bottom:8px">
    <div style="font-size:13px;color:#555;margin-bottom:6px" data-i18n="comparativa.categories"></div>
